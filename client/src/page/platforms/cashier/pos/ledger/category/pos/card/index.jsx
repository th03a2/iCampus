...
export default function PosCard({ index, activeIndex, setActiveIndex, sale }) {
  ...
  const { category, renderedBy, customerId, _id, physicianId, services } = sale;
  return (
    <MDBTypography
      note
