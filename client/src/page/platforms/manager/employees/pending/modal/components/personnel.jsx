          ...
          <MDBCol md={6}>
            <MDBInputGroup textBefore="Full Name">
              <input
                ...
                value={nameFormatter(information.user?.fullName)}
                readOnly
                autoFocus
              />
            </MDBInputGroup>
          ...
          <MDBCol md={6}>
            <MDBInputGroup textBefore="Gender">
              <input
                type="text"
                className="form-control"
                value={information.user?.isMale ? "Male" : "Female"}
                readOnly
              />
            </MDBInputGroup>
          </MDBCol>
        ...
        <MDBRow className="my-3">
          <MDBCol md={6}>
            <MDBInputGroup textBefore="Date of Birth">
              <input
                type="text"
                value={new Date(information.user?.dob).toLocaleDateString(
                  undefined,
                  options
                )}
                readOnly
          ...
          <MDBCol md={6}>
            <MDBInputGroup textBefore="Address">
              <input
                type="text"
                className="form-control"
                value={addressFormatter(information.user?.address)}
                readOnly
              />
            </MDBInputGroup>
          </MDBCol>
